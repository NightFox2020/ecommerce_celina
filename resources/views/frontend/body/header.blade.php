      ...
      <div class="header-top-inner">
        ...
        <!-- <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            @auth
            <li><a href="{{ route('login') }}"><i class="icon fa fa-user"></i>Perfil de Usuario</a></li>
            @else
            <li><a href="{{ route('login') }}"><i class="icon fa fa-lock"></i>Iniciar Sesión / Registrarse</a></li>
            @endauth
        ...
        <div class="cnt-block">
          <ul class="list-unstyled list-inline">
            ...
            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><span class="value"><i class="icon fa fa-user"> </i> Iniciar Sesión</span><b class="caret"></b></a>
