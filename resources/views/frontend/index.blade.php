      ...
      <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder"> 
        ...
        <div id="hero">
          <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
            ...
            <div class="item" style="background-image: url({{ asset('frontend/assets/images/sliders/mujer_compras.jpg') }});">
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                  <div class="slider-header fadeInDown-1">Spring 2023</div>
                  <div class="big-text fadeInDown-1"> Women <br><span class="highlight">Fashion</span> </div>
